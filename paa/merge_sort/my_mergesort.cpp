...
vector<int> combine(vector<int> left_subarray, vector<int> right_subarray) {
    ...
    for (int i=0; i <= (size_of_arrays) * 2; i++) {
        ...
        if (left_subarray_position == size_of_arrays && right_subarray_position == size_of_arrays) {
            // do nothing :P
        } else if (left_subarray_position == size_of_arrays && right_subarray_position != size_of_arrays) {
